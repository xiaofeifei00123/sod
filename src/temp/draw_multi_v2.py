...
def draw_obs(year):
    ...
    # axes[2] = fig.add_subplot(grid[0, 2:3], projection=proj)
    # axes[3] = fig.add_subplot(grid[1, 0:1], projection=proj)
    # axes[4] = fig.add_subplot(grid[1, 1:2], projection=proj)
    # axes[5] = fig.add_subplot(grid[1, 2:3], projection=proj)
